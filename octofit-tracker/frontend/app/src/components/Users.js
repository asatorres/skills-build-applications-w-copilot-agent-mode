      ...
      <div className="col-lg-10">
        <div className="card shadow mb-4">
          <div className="card-header bg-primary text-white d-flex align-items-center">
            <h2 className="mb-0 flex-grow-1"><i className="bi bi-person-fill me-2"></i>Users</h2>
          ...
          <div className="card-body">
            ...
            {users.length === 0 && (
              <div className="alert alert-info text-center mt-3">No users data available.</div>
            )}
          </div>
        </div>
      </div>
